  ...
  return (
    <Routes>
      <Route path="/" element={<Layout />}>
        ...
        <Route
          path="/prestaciones/prestadores/ver-prestador/:prestador"
          element={<VerPrestador />}
        />
        <Route
          path="/prestaciones/prestadores/ver-prestador/datos/:prestador"
          element={<DatosPrestador />}
        />
        <Route
          path="/prestaciones/prestadores/nuevo-prestador"
          element={<NuevoPrestador />}
        />
        <Route
          path="/prestaciones/prestadores/ver-prestador/agenda/:prestador"
